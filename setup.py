...
try:
    ...
    print("Please install setuptools before installing pynetflow.",
          file=sys.stderr)
    exit(1)
...
data_example_file_list = data_files_to_list('pynetflow/data')

setup(
    name='pynetflow',
    version=get_version("pynetflow/__init__.py"),
    description="",
    author=author,
    author_email=email,
    license=license,
    ...
    package_dir={'pynetflow': 'pynetflow'},
    package_data={'pynetflow': data_example_file_list},
    install_requires=['networkx', 'numpy', 'pandas', 'matplotlib', 'xgi', 'scipy', 'opencv-python'],
    entry_points={},
)
