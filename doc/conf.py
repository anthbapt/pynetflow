...
version = '.'.join((multixrank.__version__).split('.')[0:2])
# The full version, including alpha/beta/rc tags.
# release = read_setup_cfg_metadata(field='version')
release = multixrank.__version__
...
htmlhelp_basename = 'pynetflowdoc'
...
latex_documents = [
    (master_doc, 'pynetflow.tex', 'pynetflow Documentation',
     'Anthony Baptista', 'manual'),
]
...
man_pages = [
    (master_doc, 'pynetflow', 'pynetflow Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pynetflow', 'pynetflow Documentation',
     author, 'pynetflow', 'One line description of project.',
     'Miscellaneous'),
]
